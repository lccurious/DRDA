...
_C.MODEL.LAMBDA_DIST_C = 200.0
_C.MODEL.LAMBDA_DIST = 6.0
_C.MODEL.LAMBDA_ANGULAR = 3.0
_C.MODEL.LAMBDA_WASSERSTEIN = 0.001
_C.MODEL.LAMBDA_KL = 5.0
_C.MODEL.THETA_MOVE = 0.3
_C.MODEL.SOURCE_GAMMA = 1.0
_C.MODEL.BURN_IN = 0.02

# Train
_C.TRAIN = CfgNode()
_C.TRAIN.BATCH_SIZE_PER_GPU = 64
_C.TRAIN.START_EPOCH = 0
_C.TRAIN.END_EPOCH = 200000
_C.TRAIN.CLUSTER_INC_FRQ = 5000
_C.TRAIN.OPTIM = 'SGD'
_C.TRAIN.LR = 0.0003
_C.TRAIN.LR_GAMMA = 10
_C.TRAIN.BETA1 = 0.9  # Adam
